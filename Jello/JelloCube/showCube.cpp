...
////
   ...
   glTexCoord2f(0.0, 0.0); glVertex3f(jello->p[0][0][0].x, jello->p[0][0][0].y, jello->p[0][0][0].z);
   glTexCoord2f(0.0, 1.0); glVertex3f(jello->p[0][7][0].x, jello->p[0][7][0].y, jello->p[0][7][0].z);
   glTexCoord2f(1.0, 1.0); glVertex3f(jello->p[7][7][0].x, jello->p[7][7][0].y, jello->p[7][7][0].z);
   glTexCoord2f(1.0, 0.0); glVertex3f(jello->p[7][0][0].x, jello->p[7][0][0].y, jello->p[7][0][0].z);

   glTexCoord2f(0.0, 0.0); glVertex3f(jello->p[0][0][0].x, jello->p[0][0][0].y, jello->p[0][0][0].z);
   glTexCoord2f(0.0, 1.0); glVertex3f(jello->p[0][0][7].x, jello->p[0][0][7].y, jello->p[0][0][7].z);
   glTexCoord2f(1.0, 1.0); glVertex3f(jello->p[0][7][7].x, jello->p[0][7][7].y, jello->p[0][7][7].z);
   glTexCoord2f(1.0, 0.0); glVertex3f(jello->p[0][7][0].x, jello->p[0][7][0].y, jello->p[0][7][0].z);


   glTexCoord2f(0.0, 0.0); glVertex3f(jello->p[0][0][7].x, jello->p[0][0][7].y, jello->p[0][0][7].z);
   glTexCoord2f(1.0, 0.0); glVertex3f(jello->p[7][0][7].x, jello->p[7][0][7].y, jello->p[7][0][7].z);
   glTexCoord2f(1.0, 1.0); glVertex3f(jello->p[7][7][7].x, jello->p[7][7][7].y, jello->p[7][7][7].z);
   glTexCoord2f(0.0, 1.0); glVertex3f(jello->p[0][7][7].x, jello->p[0][7][7].y, jello->p[0][7][7].z);

   glTexCoord2f(0.0, 0.0); glVertex3f(jello->p[7][0][0].x, jello->p[7][0][0].y, jello->p[7][0][0].z);
   glTexCoord2f(1.0, 0.0); glVertex3f(jello->p[7][7][0].x, jello->p[7][7][0].y, jello->p[7][7][0].z);
   glTexCoord2f(1.0, 1.0); glVertex3f(jello->p[7][7][7].x, jello->p[7][7][7].y, jello->p[7][7][7].z);
   glTexCoord2f(0.0, 1.0); glVertex3f(jello->p[7][0][7].x, jello->p[7][0][7].y, jello->p[7][0][7].z);

   glTexCoord2f(0.0, 0.0); glVertex3f(jello->p[0][0][0].x, jello->p[0][0][0].y, jello->p[0][0][0].z);
   glTexCoord2f(0.0, 1.0); glVertex3f(jello->p[7][0][0].x, jello->p[7][0][0].y, jello->p[7][0][0].z);
   glTexCoord2f(1.0, 1.0); glVertex3f(jello->p[7][0][7].x, jello->p[7][0][7].y, jello->p[7][0][7].z);
   glTexCoord2f(1.0, 0.0); glVertex3f(jello->p[0][0][7].x, jello->p[0][0][7].y, jello->p[0][0][7].z);

   glTexCoord2f(0.0, 0.0); glVertex3f(jello->p[0][7][0].x, jello->p[0][7][0].y, jello->p[0][7][0].z);
   glTexCoord2f(1.0, 0.0); glVertex3f(jello->p[0][7][7].x, jello->p[0][7][7].y, jello->p[0][7][7].z);
   glTexCoord2f(1.0, 1.0); glVertex3f(jello->p[7][7][7].x, jello->p[7][7][7].y, jello->p[7][7][7].z);
   glTexCoord2f(0.0, 1.0); glVertex3f(jello->p[7][7][0].x, jello->p[7][7][0].y, jello->p[7][7][0].z);
...
void showCube(struct world * jello)
{
  ...
  if(showCheckBoard%2==1&&viewingMode!=1){  showTexture(jello);}
